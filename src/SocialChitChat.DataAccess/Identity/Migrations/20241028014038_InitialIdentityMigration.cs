    ...
    public partial class InitialIdentityMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppUserSourceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppUserLikedId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserLikes", x => new { x.AppUserSourceId, x.AppUserLikedId });
                    table.ForeignKey(
                        name: "FK_AppUserLikes_AspNetUsers_AppUserLikedId",
                        column: x => x.AppUserLikedId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppUserLikes_AspNetUsers_AppUserSourceId",
                        column: x => x.AppUserSourceId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Participants", x => new { x.ConversationId, x.AppUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserLikes_AppUserLikedId",
                table: "AppUserLikes",
                column: "AppUserLikedId");
